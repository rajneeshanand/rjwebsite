...
include('dbcon.php');
        if(isset($_POST['submit'])){
            ...
            $cpassword=$_POST['passwd'];
            

            $pass= password_hash($password, PASSWORD_BCRYPT);
            $cpass= password_hash($cpassword, PASSWORD_BCRYPT);

            $emailquery= "SELECT email FROM `aashish`.`aashishdata` WHERE email = '$email' ";
            $query=mysqli_connect($con, $emailquery);
            ...
            if($emailcount>0){
                ...
                if($password===$cpassword){
                   $sql = "INSERT INTO `aashish`.`aashishdata`(`id`, `name`, `email`, `password`, `cpassword`) VALUES (Null, '$name', '$email', '$pass', '$cpass');";
                            ...
                            <div class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <a id="btn-login" href="#" type="submit" name="login" class="btn btn-success">Login  </a>
        ...
        <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
